...
public class HttpUtils {
    ...
    public static RequestResult sendPostForm(String url, Map<String, String> header, Map<String, String> param) {
        String infoMessage = new StringBuilder().append("request postForm，url:").append(url).append("，header:").append(JacksonUtils.objToStr(header)).append("，param:").append(JacksonUtils.objToStr(param)).toString();
        if (log.isDebugEnabled()) {
